...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data, pending, error } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/movies/${movieId.value}`, {
      lazy: true
    }, "$bSu666vNSM")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(error)) {
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_Title, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a2, _b2;
                  if (_push3) {
                    _push3(`${ssrInterpolate(`${(_a2 = unref(data)) == null ? void 0 : _a2.ids.title} - ${unref(meta).title}`)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(`${(_b2 = unref(data)) == null ? void 0 : _b2.ids.title} - ${unref(meta).title}`), 1)
                    ];
                  }
                }),
                _: 1
              ...
              return [
                createVNode(_component_Title, null, {
                  default: withCtx(() => {
                    var _a2;
                    return [
                      createTextVNode(toDisplayString(`${(_a2 = unref(data)) == null ? void 0 : _a2.ids.title} - ${unref(meta).title}`), 1)
                    ];
                  }),
                  _: 1
                })
        ...
        _push(`<section class="container-fluid px-0" id="jumbotron-movie">`);
        ...
        if ((_c = unref(data)) == null ? void 0 : _c.idsposter_path, _ctx.$device.isDesktop) {
        ...
        _push(`<div class="col-sm-8 movie-details gx-5"><div class="score d-flex align-items-center"><div class="score-tag me-3">TMDb</div><div class="score-number">${ssrInterpolate((_e = unref(data)) == null ? void 0 : _e.ids.vote_average)}</div></div><div class="title">${ssrInterpolate((_f = unref(data)) == null ? void 0 : _f.ids.title)}</div><div class="details d-flex align-items-center"><div class="ratings d-flex justify-content-center align-items-center me-3">${ssrInterpolate(((_g = unref(data)) == null ? void 0 : _g.ids.adult) ? "R" : "PG")}</div><div class="year me-3">${ssrInterpolate(new Date((_h = unref(data)) == null ? void 0 : _h.ids.release_date).toUTCString().slice(5, 16))}</div><div class="time me-3">${ssrInterpolate(`${Math.floor(((_i = unref(data)) == null ? void 0 : _i.ids.runtime) / 60)} hr ${((_j = unref(data)) == null ? void 0 : _j.ids.runtime) % 60} mins`)}</div>`);
        ...
        ssrRenderList((_o = unref(data)) == null ? void 0 : _o.credits.cast.slice(0, 10), (item, index) => {
        ...
        _push(`<!--]--></div></div><div class="tab-pane fade" id="backdrops" role="tabpanel" aria-labelledby="backdrops-tab"><div class="backdrops-container"><!--[-->`);
        ssrRenderList((_p = unref(data)) == null ? void 0 : _p.photos.backdrops.slice(0, 12), (item, index) => {
        ...
        if (!((_q = unref(data)) == null ? void 0 : _q.videos.results)) {
          _push(`<div class="videos">No videos available</div>`);
        } else {
          _push(`<!--[-->`);
          ssrRenderList((_r = unref(data)) == null ? void 0 : _r.videos.results, (item, index) => {
...
//# sourceMappingURL=_id_.d8587258.mjs.map
